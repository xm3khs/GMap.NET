    ...
    public abstract class OpenStreetMapProviderBase : GMapProvider, RoutingProvider, GeocodingProvider
    {
        ...
        public Placemark? GetPlacemark(PointLatLng location, out GeoCoderStatusCode status)
        {
            ...
            */
            ...
            var pointList = GetPlacemarkFromReverseGeocoderUrl(MakeReverseGeocoderUrl(location), out status);
        ...
        */
        ...
        static readonly string GeocoderUrlFormat = "https://nominatim.openstreetmap.org/search?format=json&q={0}";

        static readonly string GeocoderDetailedUrlFormat =
            "https://nominatim.openstreetmap.org/search?format=json&street={0}&city={1}&county={2}&state={3}&country={4}&postalcode={5}";
